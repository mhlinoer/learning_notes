package com.linoer.dbsharding.config;
...
import com.linoer.dbsharding.strategy.ModuleDatabaseShardingAlgorithm;
import com.linoer.dbsharding.strategy.ModuleTableShardingAlgorithm;
 ...
 */
@Configuration
@MapperScan(basePackages = "com.linoer.dbsharding.mapper", sqlSessionTemplateRef   = "test1SqlSessionTemplate")
public class DataSourceConfig {
    ...
    public ShardingRule shardingRule(DataSourceRule dataSourceRule){
        ...
        .tableShardingStrategy(
                new TableShardingStrategy("order_id", new ModuleTableShardingAlgorithm())
        )
        ...
        bindingTableRules.add(new BindingTableRule(Collections.singletonList(orderTableRule)));
    ...
    /**
     * 创建sharding-jdbc的数据源 DataSource， MybatisAutoConfiguration会使用此数据源
     * @param shardingRule
     * @return
     * @throws SQLException
     */
